...
import { AlertCircle, FileText, CheckCircle2, Clock, Copy, Check, ThumbsUp, ThumbsDown } from 'lucide-react';
...
export const MessageItem: React.FC<MessageItemProps> = ({ message, onReaction }) => {
